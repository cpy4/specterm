...
Generate or regenerate `tasks.md` from an existing spec's approved requirements and design.
...
1. Find the spec in `.specs/specs/`. If the user named one, look for it. Otherwise, list available specs and ask which one.
