...
The user will provide an issue ID alongside this command. Detect which issue tracker MCP tools are available and use the appropriate one (Linear, Jira, or GitHub Issues). If no MCP tools are available, ask the user to paste the issue title, description, and any acceptance criteria.
